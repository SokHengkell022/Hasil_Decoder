mport os,sys,time,requests,json,random,re
...
def mr_x():
    time.sleep(1)
    os.system("clear")
    print ("\033[1;37m[\033[1;30m1\033[1;37m] \033[36m Subrek Yt \033[1;37m gw \033[36m bajingan")
    time.sleep(1)
    os.system("xdg-open https://youtube.com/@sastra12390?si=ukIJ6CF_8hNf2N1K")
    time.sleep(3)
    print ("\033[1;37m[\033[1;30m2\033[1;37m] \033[36m follow \033[1;37m github \033[36m puki")
    time.sleep(1)
    os.system("xdg-open https://github.com/Shen367?tab=followers")
    time.sleep(3)
    os.system("clear")
...
def banner_sastra():
    os.system("figlet -f bubble 'sastra'")  # Menampilkan teks dengan font bubble
    print(" ")
    print("    > PEMULA GWEH MAH")
    print("    > KALO ADA BUG BIASA GW MASIH PEMULA")
    print(" ")
    print("    > Status Otp: ERROR SYSTEM")
    print("    > Version: 2024")
    print(" ")
    print("    1. Spam Sms (DuniaGames) ")
    print("    2. Spam Call (Jagreward) ")
    print("    3. Spam Whatsapp (Tokopedia) ")
    print("    4. FOLLOW GITHUB ")
    print("")
    mr_dark_input()
